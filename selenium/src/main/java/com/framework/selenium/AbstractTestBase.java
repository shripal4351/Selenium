...
/**
 * This class is responsible for creating webdriver instance as per the desired browser type.
 * All the test classes will extend it to get the driver object
 */
...
public class AbstractTestBase {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		int implicitlyWaitTimeOut = Integer.parseInt(ConfigProperties.getConfigProperties().getProperty("implicitly.wait.timeout"));
